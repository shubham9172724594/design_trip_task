      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="absolute inset-0 flex flex-col justify-between p-6 lg:p-10">
                ...
                <div className="self-start">
                  <motion.span 
                    ...
                    className="px-4 py-2 bg-transparent border border-white text-white text-sm font-medium rounded-full"
                  >
        ...
        <div className="flex items-center justify-center mt-8 gap-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={prevSlide}
            className="w-10 h-10 bg-gray-400 hover:bg-gray-600 text-white rounded-lg flex items-center justify-center transition-colors"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={nextSlide}
            className="w-10 h-10 bg-black hover:bg-gray-800 text-white rounded-lg flex items-center justify-center transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
