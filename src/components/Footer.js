      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            >
              <h2 className="text-4xl lg:text-5xl xl:text-6xl font-black leading-none">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={prevPage}
            className="w-12 h-12 bg-gray-400 hover:bg-gray-500 text-white rounded-lg flex items-center justify-center transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
